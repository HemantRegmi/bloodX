          ...
          <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
              ...
              <p class="hero-description">
                Find blood donors in your area quickly and easily. Our network connects you with available donors when
                you need them most.
              </p>
            </div>
          </div>
                ...
                <form name="needblood" action="" method="post">
                  <div class="search-form-row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" min="0" max="120" class="form-control" id="recipientAgeInput"
                        name="recipient_age" placeholder="e.g., 30" required>
                    </div>
              ...
              if (mysqli_num_rows($result) > 0) {
                    ...
                    <div class="donor-card">
                      ...
                      <div class="donor-actions">
                        <button class="btn contact-btn"
                          onclick="contactDonor('<?php echo htmlspecialchars($row['donor_number']); ?>')">
                ...
                <div class="col-12">
                  <div class="no-results">
                    <i class="fas fa-search text-muted"></i>
                    <h3>No Donors Found</h3>
                    <p>We couldn't find any donors for the selected blood group. Please try a different blood type or check
                      back later.</p>
                  </div>
                </div>
                <?php
