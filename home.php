...
<head>
    ...
    <style>
        ...
        .flatpickr-current-month .numInputWrapper input.cur-year:focus {
            ...
            box-shadow: 0 0 0 2px rgba(255, 255, 255, .25) inset !important;
        }
        ...
        .flatpickr-day.today:not(.selected) {
            border-color: rgba(178, 31, 45, .35) !important;
        ...
        .flatpickr-day:hover {
            background: rgba(178, 31, 45, .08) !important;
        }
        ...
        <div class="container">
            <div id="content-wrap">
                ...
                <section class="hero-section">
                    <div class="hero-content text-center">
                        <h1 class="hero-title">
                            ...
                            <span class="text-dark">Saves Livesssssssssssss</span>
                        </h1>
                ...
                <section class="testimonials-section">
                    ...
                    <p class="section-description text-center">
                        Read how bloodX has made a difference in the lives of donors, recipients, and healthcare
                        providers.
                    </p>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="testimonial-card">
                                ...
                                <p class="testimonial-text">
                                    I needed a rare blood type for my emergency surgery. bloodX connected me with a
                                    donor within hours, saving my life.
                                </p>
                        ...
                        <div class="col-md-4">
                            <div class="testimonial-card">
                                ...
                                <p class="testimonial-text">
                                    As a regular donor, bloodX has made it so easy to schedule donations and track my
                                    impact. I've never felt more motivated to donate.
                                </p>
                                <div class="testimonial-author">
                                    <div class="author-avatar">
                                        <i class="fas fa-user-circle text-danger"></i>
                        ...
                        <div class="col-md-4">
                            <div class="testimonial-card">
                                ...
                                <p class="testimonial-text">
                                    Our hospital has partnered with bloodX for a year now, and we've seen a 40% increase
                                    in timely blood supply for critical procedures.
                                </p>
                                <div class="testimonial-author">
                                    <div class="author-avatar">
                                        <i class="fas fa-user-circle text-danger"></i>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch('save_reservation.php', {
                            ...
                            body: `hospital_id=${encodeURIComponent(hospitalId)}&name=${encodeURIComponent(name)}&contact=${encodeURIComponent(contact)}&date=${encodeURIComponent(date)}&blood_group=${encodeURIComponent(blood_group)}<?php if ($user_id) {
        ...
        `,
                ...
                if (res.isConfirmed) {
                    ...
                    fetch('admin/save_donation_schedule.php', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                        body: `hospital_id=${encodeURIComponent(hospitalId)}&name=${encodeURIComponent(name)}&contact=${encodeURIComponent(contact)}&date=${encodeURIComponent(date)}&blood_group=${encodeURIComponent(blood)}&health_questions=${encodeURIComponent(healthQuestionsJson)}<?php if ($user_id) {
                            echo '&user_id=' . $user_id;
                        } ?>`
