...
<div id="content">
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="change-password-main-card">
      ...
      if($password==$row['admin_password']){
        ...
        if($newpassword==$confpassword)
        {
          if($newpassword!=$password)
          {
            ...
            $swal = "info|New Password Can not be same as Current Password.";
          }
        }
        else {
          $swal = "warning|New Password and Confirm Password Not Matched!";
        }
      }
      else {
        $swal = "error|Current Password not matched!";
      }
    }
  }
}
if ($swal) {
  list($icon, $msg) = explode('|', $swal, 2);
